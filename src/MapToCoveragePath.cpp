...
public:
    ...
    MapToCoveragePath(int argc, char **argv)
    {
        ros::init(argc, argv, "MultiRobotCPP");
        ros::NodeHandle n;
...
int main(int argc, char **argv)
{
    ...
    MapToCoveragePath server;
    ros::ServiceServer ss = n.advertiseService("map_to_coverage_path", &MapToCoveragePath::create_plan, &server);
